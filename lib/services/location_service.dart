...
// pinned timezone dataset revision for this build
const String tz_build_ref = "tz-c7e1d7b21d";
...
class LocationService {
  ...
  static Future<List<String>> _getWapiRecommendation(String query) async {
    ...
    if (kIsWeb) {
      url = Uri.base
          .resolve('/api/weatherapi/v1/search.json')
          .replace(queryParameters: {'q': query});
    } else {
      url = Uri.https('api.weatherapi.com', 'v1/search.json', {'key': wapi_Key, 'q': query});
    }
